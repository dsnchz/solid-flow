...
export type SolidFlowGraphProps<NodeType extends Node = Node, EdgeType extends Edge = Edge> = {
  /**
...
export type SolidFlowKeyboardProps = {
...
export type SolidFlowViewportProps<NodeType extends Node = Node> = {
...
export type SolidFlowConnectionProps<NodeType extends Node = Node, EdgeType extends Edge = Edge> = {
  /**
...
export type SolidFlowRenderingProps = {
  /**
...
export type SolidFlowA11yProps = {
  /**
...
export type SolidFlowViewportEventProps = {
...
export type SolidFlowConnectionEventProps<
...
export type SolidFlowSelectionEventProps<
  NodeType extends Node = Node,
  EdgeType extends Edge = Edge,
> = {
...
export type SolidFlowLifecycleEventProps<
  NodeType extends Node = Node,
  EdgeType extends Edge = Edge,
> = {
...
> = NodeEvents<NodeType> &
  ...
  SolidFlowA11yProps &
  SolidFlowViewportEventProps &
  SolidFlowConnectionEventProps<NodeType, EdgeType> &
  SolidFlowSelectionEventProps<NodeType, EdgeType> &
  SolidFlowLifecycleEventProps<NodeType, EdgeType>;
